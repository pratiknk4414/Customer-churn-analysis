...
def predict():
    ...
    if prediction ==0:
        return render_template('index.html', prediction_text="Customer Will Not Churned".format(prediction))
    else:
        return render_template('index.html', prediction_text="Customer Will Churned".format(prediction))
